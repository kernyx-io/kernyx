      ...
      <aside className="wsb-hub-sidebar">
        ...
        <div className="wsb-hub-sidebar-section">
          ...
          <a
            ...
            className="wsb-hub-sidebar-store"
          >
            <span>⚓</span>
            <span>World of Sea Battle</span>
            <span className="wsb-hub-sidebar-store-arrow">↗</span>
          </a>
        </div>
      </aside>
              ...
              {TOOLS.map((tool) => (
                ...
                >
                  ...
                  <div className="wsb-hub-tool-tags">
                    {tool.tags.map((t) => (
                      <span key={t} className="wsb-hub-tag">{t}</span>
                    ))}
                  </div>
                </Link>
              ))}
              ...
              >
                <div className="wsb-hub-social-icon wsb-hub-social-reddit">
                  <svg viewBox="0 0 20 20" fill="currentColor" width="28" height="28">
                    <path d="M10 0C4.478 0 0 4.478 0 10s4.478 10 10 10 10-4.478 10-10S15.522 0 10 0zm5.93 10a1.27 1.27 0 00-2.14-.92c-1.07-.71-2.52-1.16-4.1-1.22l.7-3.28 2.27.48a.9.9 0 101.82-.1.9.9 0 00-.88.74l-2.53-.53a.19.19 0 00-.23.14l-.78 3.66c-1.61.05-3.08.5-4.17 1.22a1.27 1.27 0 10-1.38 2.06c-.03.18-.05.36-.05.55 0 2.79 3.25 5.05 7.26 5.05s7.26-2.26 7.26-5.05c0-.18-.02-.36-.05-.54A1.27 1.27 0 0015.93 10zM6.36 11.27a.9.9 0 110 1.8.9.9 0 010-1.8zm7.06 2.38c-.49.49-1.28.73-2.42.73s-1.93-.24-2.42-.73a.18.18 0 010-.26.18.18 0 01.26 0c.38.38 1.05.55 2.16.55s1.78-.17 2.16-.55a.18.18 0 01.26.26zm-.14-1.48a.9.9 0 110-1.8.9.9 0 010 1.8z" />
                  </svg>
                </div>
